...
{
    /// <summary>
    /// Drops and recreates payment tables with correct PostgreSQL column types.
    /// The original migration (20260608000000) was scaffolded for SQLite and used
    /// TEXT / INTEGER type hints that are incompatible with PostgreSQL boolean and
    /// uuid columns. This migration corrects all column types in-place.
    /// </summary>
    public partial class FixPostgresColumnTypes : Migration
    {
        ...
        {
            // Restore the SQLite-typed tables (reverting to the state after migration 20260608000000)
            migrationBuilder.DropTable(name: "PaymentAuditLogs");
            migrationBuilder.DropTable(name: "KycScreeningRecords");
            migrationBuilder.DropTable(name: "PaymentInstructions");
            migrationBuilder.DropTable(name: "WhtRateEntries");
